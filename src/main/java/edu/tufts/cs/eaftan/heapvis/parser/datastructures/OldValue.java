...
/****************************************************************************
 *A class that has been replaced by the Value Interface. This shoul be deleted once all the code
 *has been refactored.
 ***************************************************************************/
...
public class OldValue {
  ...
  public OldValue(Type type, long objVal) {
  ...
  public OldValue(Type type, boolean boolVal) {
    if (type != Type.BOOL) {
      System.err.println("Error: wrong type in Value");
      System.exit(1);
    }
  ...
  public OldValue(Type type, char charVal) {
    if (type != Type.CHAR) {
      System.err.println("Error: wrong type in Value");
      System.exit(1);
    }
  ...
  public OldValue(Type type, float floatVal) {
    if (type != Type.FLOAT) {
      System.err.println("Error: wrong type in Value");
      System.exit(1);
    }
  ...
  public OldValue(Type type, double doubleVal) {
    if (type != Type.DOUBLE) {
      System.err.println("Error: wrong type in Value");
      System.exit(1);
    }
  ...
  public OldValue(Type type, byte byteVal) {
    if (type != Type.BYTE) {
      System.err.println("Error: wrong type in Value");
      System.exit(1);
    }
  ...
  public OldValue(Type type, short shortVal) {
    if (type != Type.SHORT) {
      System.err.println("Error: wrong type in Value");
      System.exit(1);
    }
  ...
  public OldValue(Type type, int intVal) {
    if (type != Type.INT) {
      System.err.println("Error: wrong type in Value");
      System.exit(1);
    }
