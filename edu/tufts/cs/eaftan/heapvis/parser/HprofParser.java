...
package edu.tufts.cs.eaftan.heapvis.parser;

import java.io.*;
import java.util.HashMap;
import java.util.ArrayList;

import edu.tufts.cs.eaftan.heapvis.handler.RecordHandler;
...
public class HprofParser {
  ...
  private ArrayList<Instance> instanceList;
   ...
   private static final class ValueBytesReadPair{
		 public final int bytesRead;
		 public final Value value;
		 
		 ValueBytesReadPair(Value v, int b){
			 bytesRead = b;	
			 value = v;
		 }
   }
          ...
          for (int i=0; i<s1; i++) {
            ...
            switch (type) {
              ...
              case DOUBLE:     // double
                ...
                bytesRead += 8;
                v = new DoubleValue(vd);
                break;
              case BYTE:     // byte
                byte vbyte = in.readByte();
                bytesRead += 1;
                v = new ByteValue(vbyte);
                break;
              case SHORT:     // short
  ...
  private ValueBytesReadPair readValue(DataInput in, int idSize, Type type) throws IOException{
      Value v = null;
      int bytesRead = 0;
      ...
      return new ValueBytesReadPair(v, bytesRead);
